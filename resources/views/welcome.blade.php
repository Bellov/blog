...
<body class=" ">
                    ...
                    <div class="col-lg-12">
                        <div class="offers">
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">{{$windows->name}}</h4>
                            ...
                            <div class="row">
                                <div class="case-item-wrap">
                                    @foreach($windows->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                        ...
                        <div class="offers">
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">{{$development->name}}</h4>
                                        <div class="heading-line">
                                            <span class="short-line"></span>
                                            <span class="long-line"></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="case-item-wrap">
                                    @foreach($development->posts()->orderBy('created_at','desc')->take(3)->get() as $dev)
                                    <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                                <img src="{{$dev->featured}}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title">{{$dev->title}}</h6>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="offers">
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">Mac Os</h4>
                                        <div class="heading-line">
                                            <span class="short-line"></span>
                                            <span class="long-line"></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="case-item-wrap">
                                    @foreach($macos->posts()->orderBy('created_at','desc')->take(3)->get() as $macOs)
                                    <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                                <img src="{{$macOs->featured}}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title">{{$macOs->title}}</h6>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
    ...
    <!-- ...end JS Script -->
    <script id="dsq-count-scr" src="//blog-xychcmobdg.disqus.com/count.js" async></script>
