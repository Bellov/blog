...
<div class="container">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    ...
                                    <a href="#" class="w-tags-item">{{$tag->tag}}</a> @endforeach
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="blog-details-author">
        ...
        <div class="blog-details-author-thumb">
            <img style="" src="{{asset($post->user->profile->avatar)}}" width="90px" height="50px" alt="Author">
        </div>
        ...
        <div class="col-lg-12">
            <aside aria-label="sidebar" class="sidebar sidebar-right">
                <div class="widget w-tags">
                    ...
                    <div class="tags-wrap">
                        @foreach($tags as $tag)
                        <a href="{{route('single.tag',['id'=>$tag->id])}}" class="w-tags-item">{{$tag->tag}}</a> @endforeach
                    </div>
                </div>
            </aside>
        </div>
